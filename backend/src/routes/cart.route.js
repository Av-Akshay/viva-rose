...
/**
 * @swagger
 *  /cart/user/{userId}/item/{jewelleryId}:
 *   delete:
 ...
 *           type: string
 *         required: true
 *         description: The ID of the jewellery item to remove.
 *     responses:
 *       200:
 ...
 *         description: Cart not found
 */
router.delete("/user/:userId/item/:jewelleryId", cartController.removeCartItem);
